    ...
    public class Commands
    {
        ...
        private static void Resync(string[] param)
        {
            if (DateTime.UtcNow - m_LastSync > TimeSpan.FromSeconds(1.0))
            {
                ...
                ClientCommunication.Instance.SendToClient(new UnicodeMessage(0xFFFFFFFF, -1, MessageType.Regular, 0x3B2, 3,
        ...
        private static void SetWeather(string[] param)
        {
            ...
            ClientCommunication.Instance.SendToClient(new SetWeather(Convert.ToInt32(param[0]), Convert.ToInt32(param[1])));
        }
        ...
        private static void SetSeason(string[] param)
        {
            ...
            ClientCommunication.Instance.ForceSendToClient(new SeasonChange(Convert.ToInt32(param[0]), true));
        }
