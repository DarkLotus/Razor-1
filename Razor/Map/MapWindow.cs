...
namespace Assistant.MapUO
{
	...
	public class MapWindow : System.Windows.Forms.Form
	{
		...
		public MapWindow()
		{
			...
			this.Map.FullUpdate();
			ClientCommunication.Instance.SetMapWndHandle( this );
		}
			...
			if ( World.Player != null && Engine.MainWindow != null )
			{
				...
				else
				{
					if ( Engine.MainWindow.MapWindow.Visible )
					{
						...
						ClientCommunication.Instance.BringToFront( ClientCommunication.Instance.FindUOWindow() );
					}
					else
					{
						Engine.MainWindow.MapWindow.Show();
						...
						ClientCommunication.Instance.SetMapWndHandle( Engine.MainWindow.MapWindow );
					}
				}
			}
		}
		...
		private class ReqPartyLocTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				if ( ClientCommunication.Instance.ServerEncrypted )
				{
					Stop();
					return;
				}
